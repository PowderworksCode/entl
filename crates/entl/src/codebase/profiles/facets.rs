use crate::codebase::{LanguageFacet, LanguageFacetRegistration};
...
crate::codebase::profiles::registry::submit! { LanguageFacetRegistration(&COMPONENT_HOST) }
crate::codebase::profiles::registry::submit! { LanguageFacetRegistration(&STRUCTURED_CODE) }
crate::codebase::profiles::registry::submit! { LanguageFacetRegistration(&STYLE_HOST) }
