...
generated by `tools/rosetta-verbosity` from a corpus checkout. Edit the tool and
regenerate; do not hand-edit either output. See its README before changing what
gets measured — the corpus is GFDL 1.2 and none of it may enter this repository.
