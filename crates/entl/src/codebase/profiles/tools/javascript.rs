...
crate::codebase::profiles::registry::submit! { ToolRegistration(&PACKAGE_MANAGER) }
crate::codebase::profiles::registry::submit! { ToolRegistration(&TEST_RUNNER) }
crate::codebase::profiles::registry::submit! { ToolRegistration(&LINTER) }
crate::codebase::profiles::registry::submit! { ToolRegistration(&BIOME) }
crate::codebase::profiles::registry::submit! { ToolRegistration(&FORMATTER) }
crate::codebase::profiles::registry::submit! { ToolRegistration(&TYPESCRIPT) }
crate::codebase::profiles::registry::submit! { ToolRegistration(&ASTRO) }
crate::codebase::profiles::registry::submit! { ToolRegistration(&SITE_BUILDER) }
crate::codebase::profiles::registry::submit! { ToolRegistration(&NAPI) }
