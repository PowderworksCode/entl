...
use crate::github::model::deduplicate_tasks;
use crate::github::{
...
pub fn inspect(codebase: &CodebaseInventory) -> GithubInventory {
    let codeowners = crate::github::codeowners::inspect(codebase);
    let dependabot = crate::github::dependabot::inspect(codebase);
    ...
    let conventional_commits = crate::github::conventional::inspect(&workflows);
    let tool_invocations = crate::github::tool_action::invocations(&workflows);
    let action_references = crate::github::pin::references(&workflows);
    GithubInventory {
        codeowners,
...
fn job_matrix(job: &Value) -> Option<crate::github::WorkflowMatrix> {
    ...
    Some(crate::github::WorkflowMatrix { from_needs })
}
