use super::{ArtifactProfile, ArtifactRegistration};
...
crate::codebase::profiles::registry::submit! { ArtifactRegistration(&BINARY_ARTIFACT) }
crate::codebase::profiles::registry::submit! { ArtifactRegistration(&NAPI_ARTIFACT) }
crate::codebase::profiles::registry::submit! { ArtifactRegistration(&SITE_ARTIFACT) }
crate::codebase::profiles::registry::submit! { ArtifactRegistration(&TAURI_ARTIFACT) }
