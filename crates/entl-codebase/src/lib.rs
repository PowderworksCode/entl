...
pub use profiles::{
    ...
    CommentSyntax, EcosystemProfile, EcosystemRegistration, EcosystemRole, JAVASCRIPT_LANGUAGE,
    LESS_LANGUAGE, LanguageConventions, LanguageFacet, LanguageFacetRegistration, LanguageProfile,
    LanguageRegistration, LanguageRole, ManifestSelection, NAPI_ARTIFACT, NPM_ECOSYSTEM,
    PNPM_ECOSYSTEM, RUST_LANGUAGE, SCSS_LANGUAGE, SHELL_LANGUAGE, SITE_ARTIFACT, STRUCTURED_CODE,
    STYLE_HOST, STYLELINT, TAURI_ARTIFACT, TYPESCRIPT_LANGUAGE, TaskKind, TestLayoutDefaults,
    ...
    VALE, YARN_ECOSYSTEM, artifact_profile, artifact_profiles, classify_tool, comment_syntax,
    ...
    registry as profile_registry, tool_profile, tool_profiles, traversal_directories,
};
